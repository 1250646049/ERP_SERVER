...
var _require2 = require("../../db/myService/yinshouServer"),
    ...
    select2autoId = _require2.select2autoId; // 删除订单
...
router.get("/searchYsk", function _callee5(req, resp) {
...
router.post("/alterYinshou", function _callee6(req, resp) {
  var result;
...
router.post("/addYinshou", function _callee7(req, resp) {
  var result;
...
router.get("/selectShoukuan2AutoId", function _callee8(req, resp) {
  var AutoId, result;
...
router.post("/alterYinshou", function _callee9(req, resp) {
  var result;
