...
router.get("/selectYsk003", function _callee5(req, resp) {
  var _req$query3, number, type, search, result;

  return regeneratorRuntime.async(function _callee5$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          _req$query3 = req.query, number = _req$query3.number, type = _req$query3.type, search = _req$query3.search;
          _context5.prev = 1;
          _context5.next = 4;
...
router.get("/searchYsk003", function _callee7(req, resp) {
  var _req$query5, type, search, result;

  return regeneratorRuntime.async(function _callee7$(_context7) {
    while (1) {
      switch (_context7.prev = _context7.next) {
        case 0:
          _req$query5 = req.query, type = _req$query5.type, search = _req$query5.search;
          _context7.prev = 1;
          _context7.next = 4;
